 ...
 */
public class KomentarKonsulAdapter extends RecyclerView.Adapter<KomentarKonsulAdapter.GmailVH> {
    ...
    public KomentarKonsulAdapter(Context context) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(v.getRootView().getContext())
                            ...
                            .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(URLEndpoints.DELETE_COMEENTS_TOPICS + id, new Response.Listener<JSONObject>() {
                                        @Override
