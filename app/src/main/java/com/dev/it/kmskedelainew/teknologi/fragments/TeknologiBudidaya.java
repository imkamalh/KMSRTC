...
public class TeknologiBudidaya extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private static final String STATE_MISSIONS = "state_budidaya";
    private ArrayList<ItemTeknologi> mListTeknologi = new ArrayList<>();
    private AdapterBudidaya mAdapter;
    ...
    public TeknologiBudidaya() {
        // Required empty public constructor
    }

    public static TeknologiBudidaya newInstance(String param1, String param2) {
        TeknologiBudidaya fragment = new TeknologiBudidaya();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new AdapterBudidaya(getActivity());
    ...
    private void loadTeknologi(){
        if (!StateKMS.isNetworkConnected(getActivity())){
            ...
            JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(URLEndpoints.GET_LIST_TEKNOLOGI + "1", new Response.Listener<JSONArray>() {
                @Override
