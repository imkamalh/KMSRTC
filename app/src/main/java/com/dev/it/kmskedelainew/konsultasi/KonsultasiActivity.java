...
import com.dev.it.kmskedelainew.konsultasi.fragments.ForumFragment;
import com.dev.it.kmskedelainew.konsultasi.fragments.TopikFragment;
...
public class KonsultasiActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(ForumFragment.newInstance("",""), "FORUM");
        adapter.addFragment(TopikFragment.newInstance("",""), "TOPIK");
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(KonsultasiActivity.this)
                    ...
                    .setPositiveButton("Keluar", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            final ProgressDialog pDialog = new ProgressDialog(KonsultasiActivity.this);
