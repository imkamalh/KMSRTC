package com.dev.it.kmskedelainew.diskusi;
...
import com.dev.it.kmskedelainew.diskusi.adapters.HistoryAdapter;
import com.dev.it.kmskedelainew.diskusi.adt.HistoryItem;
...
public class MainActivityRTC extends ListActivity {
    private SharedPreferences mSharedPreferences;
    private String username;
    private String stdByChannel;
    private String getKMSUser;
    ...
    // untuk login menggunakan username KMS Kedelai
    SessionManager sessionManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mainrtc);
        sessionManager = new SessionManager(getApplicationContext());

        if(sessionManager.isLoggedIn()){
            //ambil informasi user yang sedang login
            HashMap<String, String> user = sessionManager.getUserDetails();
            getKMSUser = user.get(SessionManager.KEY_NAME);
        }
       ...
       /* if (!this.mSharedPreferences.contains(Constants.USER_NAME)){
        ...
        this.mUsernameTV.setText(this.getKMSUser);
        initPubNub();
                ...
                try {
                    ...
                    mPubNub.publish(callNumStdBy, jsonCall, new Callback() {
                        ...
                        public void successCallback(String channel, Object message) {
                            ...
                            Intent intent = new Intent(MainActivityRTC.this, VideoChatActivity.class);
    ...
    private void dispatchIncomingCall(String userId){
        ...
        Intent intent = new Intent(MainActivityRTC.this, IncomingCallActivity.class);
        intent.putExtra(Constants.USER_NAME, username);
    ...
    private void showToast(final String message){
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(MainActivityRTC.this, message, Toast.LENGTH_SHORT).show();
            }
        });
    }
