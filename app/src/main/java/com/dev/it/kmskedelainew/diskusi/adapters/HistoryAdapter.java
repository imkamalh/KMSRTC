package com.dev.it.kmskedelainew.diskusi.adapters;
...
import com.dev.it.kmskedelainew.diskusi.adt.ChatUser;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.callBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((MainActivityRTC)context).dispatchCall(hItem.getUser().getUserId());
            }
        });
