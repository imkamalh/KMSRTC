 ...
 */
public class AdapterNONFermentasi extends RecyclerView.Adapter<AdapterNONFermentasi.ViewHolderMissions> {
    ...
    public AdapterNONFermentasi(Context context) {
    ...
    public void onBindViewHolder(ViewHolderMissions holder, int position) {
        ...
        holder.nrLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                in.putExtra("jenis", "Non-Fermentasi");
