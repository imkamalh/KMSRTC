 ...
 */
public class AdapterArtikelTerbaru extends RecyclerView.Adapter<AdapterArtikelTerbaru.ViewHolderMissions> {
    ...
    public AdapterArtikelTerbaru(Context context) {
    ...
    public void onBindViewHolder(ViewHolderMissions holder, int position) {
        ...
        //loadImages(URLEndpoints.ARTICLE_FOLDER + currentMission.getGambarArtikel(), holder);
