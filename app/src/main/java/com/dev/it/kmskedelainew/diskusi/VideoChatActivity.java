...
import com.dev.it.kmskedelainew.diskusi.adapters.ChatAdapter;
import com.dev.it.kmskedelainew.diskusi.adt.ChatMessage;
import com.dev.it.kmskedelainew.diskusi.servers.XirSysRequest;
import com.dev.it.kmskedelainew.diskusi.util.Constants;
import com.dev.it.kmskedelainew.diskusi.util.LogRTCListener;
...
public class VideoChatActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras == null || !extras.containsKey(Constants.USER_NAME)) {
            Intent intent = new Intent(this, MainActivityRTC.class);
    ...
    private void endCall() {
        startActivity(new Intent(VideoChatActivity.this, MainActivityRTC.class));
        finish();
    }
    ...
    private class DemoRTCListener extends LogRTCListener {
        ...
        public void onPeerConnectionClosed(PnPeer peer) {
            ...
            //Intent intent = new Intent(VideoChatActivity.this, MainActivityRTC.class);
            //startActivity(intent);
            finish();
        }
    }
