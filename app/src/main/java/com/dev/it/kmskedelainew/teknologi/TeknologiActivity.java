...
import com.dev.it.kmskedelainew.teknologi.fragments.TeknologiBudidaya;
import com.dev.it.kmskedelainew.teknologi.fragments.TeknologiHama;
import com.dev.it.kmskedelainew.teknologi.fragments.TeknologiGulma;
...
public class TeknologiActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(TeknologiBudidaya.newInstance("",""), "BUDIDAYA");
        adapter.addFragment(TeknologiGulma.newInstance("",""), "GULMA");
        adapter.addFragment(TeknologiHama.newInstance("",""), "HAMA");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(TeknologiActivity.this)
                    .setTitle("Keluar")
                    .setMessage("Anda Yakin Keluar dari Aplikasi ?")
                    .setPositiveButton("Keluar", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            final ProgressDialog pDialog = new ProgressDialog(TeknologiActivity.this);
