...
import com.dev.it.kmskedelainew.artikel.adapters.AdapterArtikelPopuler;
...
public class ArtikelTerpopuler extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private static final String STATE_MISSIONS = "state_artikelpopuler";
    private ArrayList<Artikel> mListArtikel = new ArrayList<>();
    private AdapterArtikelPopuler mAdapter;
    ...
    public ArtikelTerpopuler() {
        // Required empty public constructor
    }

    public static ArtikelTerpopuler newInstance(String param1, String param2) {
        ArtikelTerpopuler fragment = new ArtikelTerpopuler();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.fragment_artikel_two, container, false);
        frameLayout = (FrameLayout) layout.findViewById(R.id.framepopular);
        progressBar = (ProgressBar) layout.findViewById(R.id.progressBarArtikelTerpopuler);
        ...
        mAdapter = new AdapterArtikelPopuler(getActivity());
    ...
    void loadNewestArticles(){
        if (!StateKMS.isNetworkConnected(getActivity())){
            ...
            JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(URLEndpoints.GET_ARTICLES_POPULAR, new Response.Listener<JSONArray>() {
                @Override
