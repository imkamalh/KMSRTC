package com.dev.it.kmskedelainew.diskusi.util;

/**
 * Created by GleasonK on 7/30/15.
 */
public class Constants {
    public static final String SHARED_PREFS = "com.dev.it.kmskedelainew.SHARED_PREFS";//"me.kg.androidrtc.SHARED_PREFS";
    public static final String USER_NAME    = "com.dev.it.kmskedelainew.SHARED_PREFS.USER_NAME";//"me.kg.androidrtc.SHARED_PREFS.USER_NAME";
    public static final String CALL_USER    = "com.dev.it.kmskedelainew.SHARED_PREFS.CALL_USER";//"me.kg.androidrtc.SHARED_PREFS.CALL_USER";
