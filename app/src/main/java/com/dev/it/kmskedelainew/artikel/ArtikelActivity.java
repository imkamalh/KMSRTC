...
import com.dev.it.kmskedelainew.artikel.fragments.ArtikelTerbaru;
import com.dev.it.kmskedelainew.artikel.fragments.ArtikelTerpopuler;
...
public class ArtikelActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(ArtikelTerbaru.newInstance("",""), "TERBARU");
        adapter.addFragment(ArtikelTerpopuler.newInstance("",""), "TERPOPULER");
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(ArtikelActivity.this)
                    ...
                    .setPositiveButton("Keluar", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            final ProgressDialog pDialog = new ProgressDialog(ArtikelActivity.this);
