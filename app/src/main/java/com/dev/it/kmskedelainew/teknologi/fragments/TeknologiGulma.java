...
import com.dev.it.kmskedelainew.teknologi.adapters.AdapterGulma;
...
public class TeknologiGulma extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private static final String STATE_MISSIONS = "state_gulma";
    private ArrayList<ItemTeknologi> mListTeknologi = new ArrayList<>();
    private AdapterGulma mAdapter;
    ...
    public TeknologiGulma() {
        // Required empty public constructor
    }

    public static TeknologiGulma newInstance(String param1, String param2) {
        TeknologiGulma fragment = new TeknologiGulma();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new AdapterGulma(getActivity());
    ...
    private void loadTeknologi(){
        if (!StateKMS.isNetworkConnected(getActivity())){
            ...
            JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(URLEndpoints.GET_LIST_TEKNOLOGI + "2", new Response.Listener<JSONArray>() {
                @Override
