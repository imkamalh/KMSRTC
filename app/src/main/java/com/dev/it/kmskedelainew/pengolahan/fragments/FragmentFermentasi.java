...
public class FragmentFermentasi extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private static final String STATE_MISSIONS = "state_fermentasi";
    private ArrayList<ItemPengolahan> mListPengolahan = new ArrayList<>();
    private AdapterFermentasi mAdapter;
    ...
    public FragmentFermentasi() {
        // Required empty public constructor
    }

    public static FragmentFermentasi newInstance(String param1, String param2) {
        FragmentFermentasi fragment = new FragmentFermentasi();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new AdapterFermentasi(getActivity());
    ...
    void loadPengolahan(){
        if (!StateKMS.isNetworkConnected(getActivity())){
            ...
            JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(URLEndpoints.GET_LIST_FERMENTASI, new Response.Listener<JSONArray>() {
                @Override
                    ...
                    try {
                        for (int i = 0; i < response.length(); i++) {
                            ...
                            ItemPengolahan itemPengolahan = new ItemPengolahan(jsonObject.getInt("id_pengolahan"), jsonObject.getString("nama_pengolahan"),
                                    jsonObject.getString("gambar_pengolahan"), StateKMS.getBgColor(i));
