...
public class PnPeerConnectionClient {
     ...
     */
    //YANG DIUBAH ADALAH IF CONDITION PAKE DIALED
            ...
            if (peers.size() < MAX_CONNECTIONS) {
                ...
                try {
                    if(!dialed) {
                        ...
                        Log.i("emosi", "jeh keno dial ?");
                        Log.i("tetep emosi", ""+dialed);
                    }
    ...
    private class PnRTCReceiver extends Callback {
        ...
        public void successCallback(String channel, Object message) {
            ...
            Log.i("successcallbak","iki sing sukses callbask");
            ...
            try {
                ...
                if (packet.has(PnRTCMessage.JSON_ICE)){
                    Log.i("iki isine opo jane", PnRTCMessage.JSON_ICE);
                    Log.i("iki sisan", packet.toString());
        ...
        public void errorCallback(String channel, PubnubError error) {
            ...
            Log.i("joss","iki callbacke'e error");
        }
